  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-6 col-xl-2 pr-0">
        ...
        <?php if(empty(\App\Setting::find(1)->setting_site_logo)): ?>
        ...
        <h1 class="mb-0 mt-1 site-logo">
          <a href="<?php echo e(route('page.home')); ?>" class="text-black mb-0">
            <img src="<?php echo e(Storage::disk('public')->url('setting/' . \App\Setting::find(1)->setting_site_logo)); ?>">
          </a>
        </h1>
        <?php endif; ?>
      ...
      <div class="col-12 col-md-10 d-none d-xl-block">
        <nav class="site-navigation position-relative text-right" role="navigation">
          ...
          <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
            ...
            <?php if(\App\Setting::find(1)->setting_page_about_enable == \App\Setting::ABOUT_PAGE_ENABLED): ?>
      ...
      <div class="d-inline-block d-xl-none ml-auto py-3 col-6 text-right" id="menu-mobile-div">
...
</header><?php /**PATH /Applications/projects/hellodanang/laravel_project/resources/views/frontend/partials/nav.blade.php ENDPATH**/ ?>