        ...
        <div class="owl-carousel nonloop-block-13">
          ...
          <div class="d-block d-md-flex listing vertical">
            ...
            <div class="lh-content">
              <a href="<?php echo e(route('page.category', $item->category->category_slug)); ?>">
                <span class="category"><?php echo e($item->category->category_name); ?></span>
              </a>

              <h3><a href="<?php echo e(route('page.item', $item->item_slug)); ?>"><?php echo e(str_limit($item->item_title, 44, '...')); ?></a></h3>
              <address>
      ...
      <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
        ...
        <div class="listing-item listing">
          ...
          <div class="listing-item-content">
            ...
            <a class="px-3 mb-3 category" href="<?php echo e(route('page.category', $item->category->category_slug)); ?>"><?php echo e($item->category->category_name); ?></a>
            <h2 class="mb-1"><a href="<?php echo e(route('page.item', $item->item_slug)); ?>"><?php echo e($item->item_title); ?></a></h2>
            <span class="address">
              <a href="<?php echo e(route('page.city', ['state_slug'=>$item->state->state_slug, 'city_slug'=>$item->city->city_slug])); ?>"><?php echo e($item->city->city_name); ?></a>,
              <a href="<?php echo e(route('page.state', ['state_slug'=>$item->state->state_slug])); ?>"><?php echo e($item->state->state_name); ?></a>
            </span>
      ...
      <div class="col-lg-6">
        <div class="d-block d-md-flex listing">
          ...
          <div class="lh-content">
            ...
            <h3><a href="<?php echo e(route('page.item', $item->item_slug)); ?>"><?php echo e($item->item_title); ?></a></h3>
            <address>
              <a href="<?php echo e(route('page.city', ['state_slug'=>$item->state->state_slug, 'city_slug'=>$item->city->city_slug])); ?>"><?php echo e($item->city->city_name); ?></a>,
              <a href="<?php echo e(route('page.state', ['state_slug'=>$item->state->state_slug])); ?>"><?php echo e($item->state->state_name); ?></a>
            </address>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/projects/hellodanang/laravel_project/resources/views/frontend/index.blade.php ENDPATH**/ ?>