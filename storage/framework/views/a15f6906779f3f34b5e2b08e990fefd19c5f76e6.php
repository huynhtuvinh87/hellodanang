    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-6">
        <div class="d-block d-md-flex listing">
          <a href="<?php echo e(url($similar_item->item_slug.'-'.$similar_item->id)); ?>" class="img d-block" style="background-image: url(<?php echo e(!empty($similar_item->item_image_small) ? Storage::disk('public')->url('item/' . $similar_item->item_image_small) : (!empty($similar_item->item_image) ? Storage::disk('public')->url('item/' . $similar_item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_small.jpg'))); ?>)"></a>
          <div class="lh-content">
            <a href="<?php echo e(route('page.category', $similar_item->category->category_slug)); ?>">
              <span class="category"><?php echo e($similar_item->category_name); ?></span>
            </a>

            <h3><a href="<?php echo e(url( $similar_item->item_slug.'-'.$similar_item->id)); ?>"><?php echo e($similar_item->item_title); ?></a></h3>
            <address>
              <a href="<?php echo e(route('page.city', ['state_slug'=>$similar_item->state->state_slug, 'city_slug'=>$similar_item->city_slug])); ?>"><?php echo e($similar_item->city_name); ?></a>
            ...
            <div class="row">
              <div class="col-2 pr-0">
                ...
                <img src="<?php echo e(asset('frontend/images/placeholder/profile-'. intval($similar_item->user_id % 10) . '.jpg')); ?>" alt="Image" class="img-fluid rounded-circle">
                <?php else: ?>

                <img src="<?php echo e(Storage::disk('public')->url('user/' . $similar_item->user_image)); ?>" alt="<?php echo e($similar_item->fullname); ?>" class="img-fluid rounded-circle">
                <?php endif; ?>
              </div>
              <div class="col-10 line-height-1-2">
                ...
                <div class="row pb-1">
                  <div class="col-12">
                    <span class="font-size-13"><?php echo e($similar_item->fullname); ?></span>
                  </div>
                </div>
...
<div class="site-section bg-light">
  <div class="container">
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-6">
        <div class="d-block d-md-flex listing">
          <a href="<?php echo e(url($nearby_item->item_slug.'-'.$nearby_item->id)); ?>" class="img d-block" style="background-image: url(<?php echo e(!empty($nearby_item->item_image_small) ? Storage::disk('public')->url('item/' . $nearby_item->item_image_small) : (!empty($nearby_item->item_image) ? Storage::disk('public')->url('item/' . $nearby_item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_small.jpg'))); ?>)"></a>
          <div class="lh-content">
            <a href="<?php echo e(route('page.category', $nearby_item->category->category_slug)); ?>">
              <span class="category"><?php echo e($nearby_item->category_name); ?></span>
            </a>

            <h3><a href="<?php echo e(url($nearby_item->item_slug.'-'.$nearby_item->id)); ?>"><?php echo e($nearby_item->item_title); ?></a></h3>
            <address>
              <a href="<?php echo e(route('page.city', ['state_slug'=>$nearby_item->state->state_slug, 'city_slug'=>$nearby_item->city_slug])); ?>"><?php echo e($nearby_item->city_name); ?></a>
            </address>
            ...
            <div class="row">
              <div class="col-2 pr-0">
                ...
                <img src="<?php echo e(Storage::disk('public')->url('user/' . $nearby_item->user_image)); ?>" alt="<?php echo e($nearby_item->fullname); ?>" class="img-fluid rounded-circle">
                <?php endif; ?>
              </div>
              <div class="col-10 line-height-1-2">
                ...
                <div class="row pb-1">
                  <div class="col-12">
                    <span class="font-size-13"><?php echo e($nearby_item->fullname); ?></span>
                  </div>
                </div>
                <div class="row line-height-1-0">
                  <div class="col-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/projects/hellodanang/resources/views/frontend/item.blade.php ENDPATH**/ ?>