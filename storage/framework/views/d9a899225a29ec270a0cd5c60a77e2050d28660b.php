                        ...
                        <div class="col-12">
                            <form class="form-inline" action="<?php echo e(route('admin.items.create')); ?>" method="GET">
                                <div class="form-group mr-2">
                                    <select class="custom-select <?php $__errorArgs = ['category'];
...
unset($__errorArgs, $__bag); ?>" name="category" onchange="$('#item-create-form').remove();">
                                        <option><?php echo e(__('backend.item.select-category')); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                <input name="category" value="<?php echo e($category_id); ?>" type="hidden" id="input_category_id">
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="item_phone" value="<?php echo e(old('item_phone')); ?>" aria-describedby="lngHelpBlock">
                        ...
                        <div class="form-row">
                            <?php $__currentLoopData = $all_customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-3 mb-3">
                                    <?php if($customField->custom_field_type == \App\CustomField::TYPE_STRING): ?>
                                        ...
                                        <input class="form-control <?php $__errorArgs = [str_slug($customField->custom_field_name . $customField->id)];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="<?php echo e(str_slug($customField->custom_field_name . $customField->id)); ?>" rows="5" name="<?php echo e(str_slug($customField->custom_field_name . $customField->id)); ?>" value="<?php echo e(old(str_slug($customField->custom_field_name . $customField->id))); ?>">
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/projects/hellodanang/resources/views/backend/admin/item/create.blade.php ENDPATH**/ ?>