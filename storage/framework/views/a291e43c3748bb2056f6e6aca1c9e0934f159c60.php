...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row">
                <div class="col-6">
                    <form method="POST" action="<?php echo e(route('admin.custom-fields.update', $customField)); ?>" class="p-5">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="row form-group">
                            <div class="col-md-12">
                                <?php echo e(__('backend.category.category')); ?>: <?php echo e($customField->category->category_name); ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="custom-select" name="custom_field_type">
                                    <option value="<?php echo e(\App\CustomField::TYPE_STRING); ?>" <?php echo e((old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\CustomField::TYPE_STRING ? 'selected' : ''); ?>><?php echo e(__('backend.custom-field.string')); ?></option>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/projects/hellodanang/resources/views/backend/admin/custom-field/edit.blade.php ENDPATH**/ ?>