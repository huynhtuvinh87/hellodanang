...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row">
                <div class="col-6">
                    <form method="POST" action="{{ route('user.profile.update') }}" class="p-5">
                        @csrf
                                ...
                                <div class="row mt-3">
                                    <div class="col-8">
                                        ...
                                        @if(empty($login_user->user_image))
                                            <img id="image_preview" src="{{ asset('frontend/images/placeholder/profile-' . intval($login_user->id % 10) . '.jpg') }}" class="img-responsive">
                                        @else
