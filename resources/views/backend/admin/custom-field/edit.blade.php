...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row">
                <div class="col-6">
                    <form method="POST" action="{{ route('admin.custom-fields.update', $customField) }}" class="p-5">
                        @csrf
                        @method('PUT')
                        <div class="row form-group">
                            <div class="col-md-12">
                                {{ __('backend.category.category') }}: {{ $customField->category->category_name }}
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="custom-select" name="custom_field_type">
                                    <option value="{{ \App\CustomField::TYPE_STRING }}" {{ (old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\CustomField::TYPE_STRING ? 'selected' : '' }}>{{ __('backend.custom-field.string') }}</option>
