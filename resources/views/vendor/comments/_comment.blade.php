...
@endif
          ...
          @else
              <img class="mr-3 rounded-circle" src="{{ asset('frontend/images/placeholder/profile-' . intval($comment->commenter->id % 10) . '.jpg') }}" alt="{{ $comment->commenter->name ?? $comment->guest_name }} Avatar" width="64">
          @endif
