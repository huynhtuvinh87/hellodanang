...
class SocialMediaController extends Controller
{
    ...
    public function index()
    {
        ...
        //SEOMeta::setTitle('Dashboard - Social Media - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
    ...
    public function create()
    {
         ...
         */
        $settings = Setting::find(1);
        //SEOMeta::setTitle('Dashboard - Create Social Media - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
    ...
    public function store(Request $request)
    {
        ...
        $social_media->social_media_name = ucwords(strtolower($request->social_media_name));
        $social_media->social_media_icon = strtolower($request->social_media_icon);
        $social_media->social_media_link = strtolower($request->social_media_link);
    ...
    public function edit(SocialMedia $socialMedia)
    {
         ...
         */
        $settings = Setting::find(1);
        //SEOMeta::setTitle('Dashboard - Edit Social Media - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
    ...
    public function update(Request $request, SocialMedia $socialMedia)
    {
        ...
        $socialMedia->social_media_name = ucwords(strtolower($request->social_media_name));
        $socialMedia->social_media_icon = strtolower($request->social_media_icon);
        $socialMedia->social_media_link = strtolower($request->social_media_link);
