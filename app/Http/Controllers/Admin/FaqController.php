...
class FaqController extends Controller
{
    ...
    public function index()
    {
        ...
        //SEOMeta::setTitle('Dashboard - Faqs - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
    ...
    public function create()
    {
         ...
         */
        $settings = Setting::find(1);
        //SEOMeta::setTitle('Dashboard - Create Faq - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
    ...
    public function store(Request $request)
    {
        ...
        $faq = new Faq();
        $faq->faqs_question = ucfirst(strtolower($request->faqs_question));
        $faq->faqs_answer = ucfirst($request->faqs_answer);
    ...
    public function edit(Faq $faq)
    {
         ...
         */
        $settings = Setting::find(1);
        //SEOMeta::setTitle('Dashboard - Edit Faq - ' . (empty($settings->setting_site_name) ? config('app.name', 'Laravel') : $settings->setting_site_name));
